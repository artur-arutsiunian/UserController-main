...
public class CreateResponseDto {
    ...
    public CreateResponseDto(CreateRes res) {
        this.files = List.of(new Files(res.getAge(),
                Optional.ofNullable(res.getGender())
                        .map(Enum::name)
                        .orElse(null),
                res.getLogin(),
                res.getPassword(),
                Optional.ofNullable(res.getRole())
                        .map(Enum::name)
                        .orElse(null),
                res.getScreenName()));
    }
    ...
    public static class Files{
        ...
        public Files(int age, String gender, String login, String password, String role, String screenName) {
            this.age = age;
            this.gender = gender;
            this.login = login;
